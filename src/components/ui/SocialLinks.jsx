  ...
  return (
    <>
      ...
      <div className="visitor-counter">
        ...
        <span className="visitor-label">total visitor</span>
        <img
          src="https://api.visitorbadge.io/api/visitors?path=https%3A%2F%2Fwww.sakhiardra.my.id%2F&label=total%20visitor&countColor=%23263759&style=plastic"
          alt="visitors"
