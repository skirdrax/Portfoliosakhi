    ...
    case 'instagram':
      return (
        <svg width="17" height="17" fill="currentColor" viewBox="0 0 24 24">
          ...
          <circle cx="18.406" cy="5.555" r="1.44" />
        </svg>
      );
    default:
      return null;
...
export default function Footer() {
  return (
    <>
      <style>{`
        .footer-line { height: 1px; background: linear-gradient(90deg, transparent, rgba(37,99,235,.4) 30%, rgba(59,130,246,.6) 50%, rgba(37,99,235,.4) 70%, transparent); }
        .footer { display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 14px; padding: 28px 0 40px; }
