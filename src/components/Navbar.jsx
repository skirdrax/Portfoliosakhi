...
export default function Navbar() {
  ...
  .nav-link::after { content:''; position:absolute; bottom:-2px; left:0; width:0; height:1.5px; background: #2563eb; border-radius:2px; transition:width .25s cubic-bezier(.22,1,.36,1); }
